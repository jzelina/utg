...
#######################
	...
	if ($_POST['type'] == "RSSFeed")
		...
		$content["0"]["app"] = "rss";
		$content["0"]["function"] = "APP_RSS_GET_FEED";
		$content["0"]["description"] = $_POST['description'];
		$content["0"]["URL"] = $_POST['rssurl'];
	...
	echo '<body><form method="post" action="'.$XML_SERVER.'?setup=rss.php">
			<table style="width: 300px; margin-left: auto; margin-right: auto;">
				...
				<tr>
					<td>Type</td>
					<td><select name="type"><option value="RSSFeed">RSSFeed</option></select></td>
				</tr>
				<tr>
				...
				<tr>
					<td>RSS URL</td>
					<td><input type="text" name="rssurl" value="http://feeds.feedburner.com/TechCrunch/"/></td>
				</tr>
				<tr>
					<td>OK-URL</td>
